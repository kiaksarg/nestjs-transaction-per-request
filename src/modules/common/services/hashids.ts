...
export class HashidsService {
  ...
  public constructor(
    ...
    this.seps = shuffle(filteredSeps, saltChars); //DevSkim: ignore DS148264
    ...
    this.alphabet = shuffle(this.alphabet, saltChars); //DevSkim: ignore DS148264
  ...
  private _encode(numbers: NumberLike[]): string[] {
    ...
    numbers.forEach((number, i) => {
      ...
      alphabet = shuffle(alphabet, buffer); //DevSkim: ignore DS148264
    ...
    while (ret.length < this.minLength) {
      alphabet = shuffle(alphabet, alphabet); //DevSkim: ignore DS148264
